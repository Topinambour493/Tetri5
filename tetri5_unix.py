...
piece_vert_clair = pygame.image.load("images\piece_vert_clair.png").convert_alpha()
piece_vert_foncé = pygame.image.load("images\piece_vert_foncé.png").convert_alpha()
piece_vert_bleu = pygame.image.load("images\piece_vert_bleu.png").convert_alpha()
piece_bleu_clair = pygame.image.load("images\piece_bleu_clair.png").convert_alpha()
piece_bleu_normal = pygame.image.load("images\piece_bleu_normal.png").convert_alpha()
piece_bleu_foncé = pygame.image.load("images\piece_bleu_foncé.png").convert_alpha()
piece_jaune = pygame.image.load("images\piece_jaune.png").convert_alpha()
piece_orange = pygame.image.load("images\piece_orange.png").convert_alpha()
piece_rouge = pygame.image.load("images\piece_rouge.png").convert_alpha()
piece_rose_clair = pygame.image.load("images\piece_rose_clair.png").convert_alpha()
piece_rose_foncé = pygame.image.load("images\piece_rose_foncé.png").convert_alpha()
piece_violet = pygame.image.load("images\piece_violet.png").convert_alpha()
ghost_piece_vert_clair = pygame.image.load("images\ghost_piece_vert_clair.png").convert_alpha()
ghost_piece_vert_foncé = pygame.image.load("images\ghost_piece_vert_foncé.png").convert_alpha()
ghost_piece_vert_bleu = pygame.image.load("images\ghost_piece_vert_bleu.png").convert_alpha()
ghost_piece_bleu_clair = pygame.image.load("images\ghost_piece_bleu_clair.png").convert_alpha()
ghost_piece_bleu_normal = pygame.image.load("images\ghost_piece_bleu_normal.png").convert_alpha()
ghost_piece_bleu_foncé = pygame.image.load("images\ghost_piece_bleu_foncé.png").convert_alpha()
ghost_piece_jaune = pygame.image.load("images\ghost_piece_jaune.png").convert_alpha()
ghost_piece_orange = pygame.image.load("images\ghost_piece_orange.png").convert_alpha()
ghost_piece_rouge = pygame.image.load("images\ghost_piece_rouge.png").convert_alpha()
ghost_piece_rose_clair = pygame.image.load("images\ghost_piece_rose_clair.png").convert_alpha()
ghost_piece_rose_foncé = pygame.image.load("images\ghost_piece_rose_foncé.png").convert_alpha()
ghost_piece_violet = pygame.image.load("images\ghost_piece_violet.png").convert_alpha()
image_reserve= pygame.image.load("images\RESERVE_tetri5.png").convert_alpha()
image_suivant=pygame.image.load("images\SUIVANT_tetri5.png").convert_alpha()
